...
/***/ (function (module, exports, __webpack_require__) {
        ...
        var Frame = /** @class */ (function () {
          ...
          Object.defineProperty(Frame.prototype, "body", {
            ...
            get: function () {
              if (!this._body && this.isBinaryBody) {
                this._body = new wx.TextDecoder().decode(this._binaryBody);
              }
              return this._body;
            },
            enumerable: true,
          ...
          Object.defineProperty(Frame.prototype, "binaryBody", {
            ...
            get: function () {
              if (!this._binaryBody && !this.isBinaryBody) {
                this._binaryBody = new wx.TextEncoder().encode(this._body);
              }
          ...
          Frame.sizeOfUTF8 = function (s) {
            return s ? new wx.TextEncoder().encode(s).length : 0;
          };
          Frame.toUnit8Array = function (cmdAndHeaders, binaryBody) {
            var uint8CmdAndHeaders = new wx.TextEncoder().encode(cmdAndHeaders);
...
/***/ (function (module, exports, __webpack_require__) {
        ...
        var Parser = /** @class */ (function () {
          function Parser(onFrame, onIncomingPing) {
            ...
            this._encoder = new wx.TextEncoder();
            this._decoder = new wx.TextDecoder();
            this._token = [];
            this._initState();
          }
